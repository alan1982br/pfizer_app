	...
	{*/
		...
		$.getJSON(ExternalURL+'adm/lib/php/sm_login.php?acao=login&login='+e+'&format=json',function(data){//&callback=?
				...
				else
				{
					...
					userTransfer = data.mensagem[0]['usuariosTransfer'];
					userStatus = data.mensagem[0]['usuariosStatus'];
					userCheckOut = data.mensagem[0]['usuariosCheckOut'];
				...
				if(userCheckOut == '0')
				{
					...
					$('#ulSalas').append('<li>ID: <input type="text" id="user_id" value="" data-theme="c" disabled/>Nome: <input type="text" id="user_nome" value="" data-theme="c" />Status: <input type="text" id="user_status" value="" data-theme="c"/><label><input type="checkbox" name="user_checkOut" id="user_checkOut" class="nCheck" onClick="validaCheck(this)">CheckOut</label></li>');
					$("#user_checkOut").removeClass('Check').addClass('nCheck');
				}
				else if(userCheckOut == '1')
				{
					$('#ulSalas').append('<li>ID: <input type="text" id="user_id" value="" data-theme="c" disabled/>Nome: <input type="text" id="user_nome" value="" data-theme="c" />Status: <input type="text" id="user_status" value="" data-theme="c"/><label><input type="checkbox" name="user_checkOut" id="user_checkOut" class="nCheck" onClick="validaCheck(this)" checked>CheckOut</label></li>');
					$("#user_checkOut").removeClass('nCheck').addClass('Check');
				}
				$("#user_id").val(userId);
				...
				//$("#user_checkOut").val(userCheckOut);
				/*
...
function handleUpDate()
{
	...
	$.getJSON(ExternalURL+'adm/lib/php/sm_usuarios.php?acao=update&id='+userId+'&nome='+$("#user_nome").val()+'&status='+$("#user_status").val()+'&checkOut='+userCheck+'&format=json',function(data){//&callback=?
